// src/pages/caregiver/health/HealthRecordListPage.jsx
...
function HealthRecordListPage() {
    ...
    const fetchHealthRecords = useCallback(async () => {
        ...
        setError('');
        try {
            // ใช้ Endpoint เดิมที่เราสร้างไว้สำหรับดึงข้อมูลสุขภาพ
    ...
    return (
        <div className="flex flex-col h-screen bg-gray-100">
            <header className="bg-green-500 text-white p-4 shadow-md flex items-center sticky top-0 z-10">
                ...
                <h1 className="text-xl font-bold">ข้อมูลสุขภาพ: {decodeURIComponent(elderName)}</h1>
            </header>
